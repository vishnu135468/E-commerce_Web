...
//preload function is used to get the categories from the backend
  ...
  //preloadCategories is used to get the categories from the backend
  ...
  useEffect(() => {
    preload(match.params.productId); //match.params.productId is used to get the productId from the url
  }, []);
